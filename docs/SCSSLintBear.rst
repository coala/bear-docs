...
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
| ``allow_consecutives_duplicate_property``  | Allows defining the same property consecutively in a         |
|                                            | single rule set. (Optional, defaults to 'False'.)            |
|                                            |                                                              |
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
...
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
| ``allow_trailing_semicolon``               | Property values; ``@extend``, ``@include``, and              |
|                                            | ``@import`` directives; and variable declarations should     |
|                                            | always end with a semicolon. (Optional, defaults to 'True'.) |
|                                            |                                                              |
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
...
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
| ``allow_unnecessary_mantissa``             | Numeric values can contain unnecessary fractional            |
|                                            | portions. (Optional, defaults to 'False'.)                   |
|                                            |                                                              |
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
...
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
| ``check_pseudo_elements``                  | Pseudo-elements, like ``::before``, and                      |
|                                            | ``::first-letter``, should be declared with two colons.      |
|                                            | Pseudo-classes, like ``:hover`` and ``:first-child``,        |
|                                            | should be declared with one colon.                           |
|                                            | :: p::before { content: '>' }                                |
|                                            | p:hover { color: red; }                                      |
...
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
| ``disabled_properties``                    | List of existing properties to deny. (Optional, defaults     |
|                                            | to '()'.)                                                    |
|                                            |                                                              |
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
...
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
| ``max_properties``                         | Enforces a limit on the number of properties in a rule       |
|                                            | set. (Optional, defaults to '10'.)                           |
|                                            |                                                              |
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
...
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
| ``use_length_variables``                   | Prefer length literals (numbers with units) to be used       |
...
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
| ``use_short_hexadecimal_length_style``     | Prefer shorthand or long-form hexadecimal colors by          |
|                                            | setting the style option to short or long, respectively.     |
|                                            | (Optional, defaults to 'True'.)                              |
|                                            |                                                              |
+--------------------------------------------+--------------------------------------------------------------+
|                                            |                                                              |
